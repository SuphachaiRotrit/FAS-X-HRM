...
const main: ThemeDefinition = {
  ...
  colors: {
    ...
    'primary-lighten-4': '#BEE1FC',
    'primary-lighten-5': '#E9F5FE',
    'primary-darken-1': '#207CC6',
    'primary-darken-2': '#1C6CAD',
    'primary-darken-3': '#185D94',
    'primary-darken-4': '#144D7B',
    'primary-darken-5': '#103E63',
    secondary: '#5F5F5F',
